...
.icon-box { padding:12px; border-radius:10px; }
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="d-flex justify-content-between border-bottom py-2">
                        ...
                        <span class="fw-bold text-success">{{ $dataSynced['invoices'] }}</span>
                    </div>
                    <div class="d-flex justify-content-between border-bottom py-2">
                        <span class="text-muted">Customers:</span>
                        <span class="fw-bold text-success">{{ $dataSynced['customers'] }}</span>
                    </div>
                    <div class="d-flex justify-content-between border-bottom py-2">
                        <span class="text-muted">Payments:</span>
                        <span class="fw-bold text-success">{{ $dataSynced['payments'] }}</span>
                    </div>
                    <div class="d-flex justify-content-between py-2">
                        <span class="text-muted">Last Update:</span>
                        <span class="fw-bold">{{ $dataSynced['last_update'] }}</span>
                    </div>
                </div>
            </div>
        </div>
