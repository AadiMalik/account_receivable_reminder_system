                    ...
                    <tbody>
                        @foreach ($customers as $customer)
                            <tr>
                                ...
                                <td
                                    class="d-none d-lg-table-cell {{ $customer['overdue'] > 0 ? 'text-danger' : 'text-muted' }}">
                                ...
                                <td>
                                    <a class="btn btn-outline-secondary btn-sm" href="{{ url('customer/detail/' . $customer['customer_code']) }}">View</a>
                                </td>
                            </tr>
                        @endforeach
                    </tbody>
